...
import { Plus, Minus, Trash2, Save, X, Pencil } from "lucide-react"
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <RadioGroup
                                ...
                                className="col-span-3 flex flex-col md:flex-row items-start"
                            >
                                ...
                                {nuevosProductos === null ? (
                                    ...
                                    <ScrollArea className="flex flex-col w-full">
                                        {nuevosProductos.map((item, index) => (
                                            <div key={index} className="flex flex-col md:flex-row w-full items-center md:justify-between p-3 gap-2">
